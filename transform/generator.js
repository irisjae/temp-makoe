...
<script>
	...
	; Oo (next .querySelectorAll ('#launch-video #hint[for=video]'),
		oO (R .forEach (x => {{
			x .querySelector ('rect') .setAttribute ('fill', '#00000000')
			x .innerHTML += embed ('launch-video', '<iframe width="560" height="315" src="https://www.youtube.com/embed/SogZCnmd7d0?rel=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>')
		}})))
	; Oo (next .querySelectorAll ('#launch-photos #hint[for=album]'),
		oO (R .forEach (x => {{
			x .querySelector ('rect') .setAttribute ('fill', '#00000000')
			x .innerHTML += embed ('launch-photos', '<iframe src="https://www.kodingkingdom.com/home/wp-admin/admin-ajax.php?action=h5p_embed&id=1" width="958" height="704" frameborder="0" allowfullscreen="allowfullscreen"></iframe><script src="https://www.kodingkingdom.com/home/wp-content/plugins/h5p/h5p-php-library/js/h5p-resizer.js" charset="UTF-8"></script>', 'padding-bottom: 10px;')
		}})))
	; Oo (next .querySelectorAll ('#red-cliff #hint[for=video]'),
		oO (R .forEach (x => {{
			x .querySelector ('rect') .setAttribute ('fill', '#00000000')
			x .innerHTML += embed ('red-cliff', '<iframe width="560" height="315" src="https://www.youtube.com/embed/h_kqgzjSA4w?rel=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>')
		}})))
        return next
})
